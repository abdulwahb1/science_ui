    ...
    <section className="flex flex-col items-center justify-between w-full">
      <div className="flex flex-col md:flex-row md:px-5">
        <div className="flex flex-col items-center justify-center w-full px-5 py-5 ">
          <h1 className="text-3xl font-extrabold md:text-left text-center text-black py-5 md:text-6xl">
            Our <span className="text-custom-violet"> mission </span> is to
            bring <span className="text-custom-violet"> research </span>and
            communities closer
          </h1>
          <p className="text-sm md:text-lg text-center font-normal text-black leading-5 md:text-left">
        ...
        <div className=" px-2 relative md:w-3/4 md:py-10">
